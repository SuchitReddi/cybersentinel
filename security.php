...
if( isset( $_POST['seclev_submit'] ) ) {
	...
	sentinelMessagePush( "Security level set to {$securityLevel}" );
	sentinelPageReload();
}
...
<div class=\"body_padded\">
	...
	<form action=\"#\" method=\"POST\">
		{$securityLevelHtml}
		<p>You can set the security level to low, medium, high or impossible. The security level changes the vulnerability level of Cyber Sentinel:</p>
		<ol>
			...
			<li> Impossible - This level should be <em>secure against all vulnerabilities</em>. It is used to compare the vulnerable source code to the secure source code.<br /></li>
		</ol>
